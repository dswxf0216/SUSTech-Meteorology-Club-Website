...
function WeatherIcon({ symbol }: { symbol: WeatherSymbol }) {
  ...
  return <svg viewBox="0 0 64 64" width="52" height="52" focusable="false">
    {sun && <g transform={symbol === 'sun' ? 'translate(-8 0)' : undefined} stroke="#e7aa22" strokeWidth="2.5" strokeLinecap="round"><circle cx="40" cy="21" r="9" fill="#ffd35a" />{Array.from({ length: 8 }, (_, i) => <path key={i} d="M40 5v3" transform={`rotate(${i * 45} 40 21)`} />)}</g>}
